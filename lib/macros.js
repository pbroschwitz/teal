...
exports.sheet = function(name, sheets, flattenMedia) {
  if (!sheets) sheets = ['default']
  if (!Array.isArray(sheets)) sheets = [sheets]
  var opts = { sheets: sheets, flattenMedia: flattenMedia }
  return this.teal.css.sheet(name, opts)
}
