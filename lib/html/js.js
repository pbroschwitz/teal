...
module.exports = function(html) {
  ...
  return {
    ...
    root: function(node) {
      var defaults = {}
      var ctx = { defaults: defaults }

      this.visit(node.settings, ctx)
      var root = this.visit(node.root, ctx)
      ...
      return join(
        ...
        f('module.exports=exports=function(data){\n%s\n}', join(
          f('var scope=_.scope(arguments, this, %j)', defaults),
          'return ' + root
        )),
    ...
    defaults: function(node) {
      grep(node.declarations, 'attribute').forEach(function(a) {
        this.defaults[a.name] = a.value
      }, this)
    },
