...
DefaultStyle
  = sel:DefaultSelectors __ decl:CssBlock {
...
Element
  = name:(PathLiteral / Identifier / TagExp) _ cls:ClassName? __ decl:Declarations {
...
Css
  = css:(Property / Style / Media / Sheet / Animation / Element / PathLiteral) {
    if (css.type == 'path') css = { type: 'element', name: css }
...
Each
  = '@each' __ v:Variable __ i:EachIndex? 'in' __ e:(Exp/Block) __ body:Content {
...
TernaryExpression
  = exp:BinaryExpression __ '?' __ truthy:(Exp/Block) __ ':' __ falsy:(Exp/Block) {
