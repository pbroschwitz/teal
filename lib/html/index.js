...
function HTML(teal) {
  ...
  this.runtime = __dirname + '/dom'
  this.prepare = visitor(prepare(this))
  this.visitor = visitor(js(this))
  this.code = {}
  this.cache = {}
...
HTML.prototype.functions = require('./functions')
