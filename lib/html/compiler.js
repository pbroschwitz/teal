...
Compiler.prototype.invalidate = function(file) {
  if (Array.isArray(file)) file.forEach(this.invalidate, this)
  var prev = this.prevCode[file] = this.code[file]
  this.code[file] = undefined
  return prev
}
