  ...
  ctx.asts.forEach(function(ast) {
    ...
    var v = visitor({
      ...
      root: function(node) {
        ...
        if (node.root) {
          // skip mixins
          if (node.root.type == 'fragment') return
      ...
      reference: function(node) {
        ...
        this.visitDeclarations(node, null, function(d) {
          if (!ref || !~ref.cssVars.indexOf(d.property)) return true
        ...
        if (ref) {
          ...
          this.visit(ref.root, {
            ...
            prefix: mixin ? '' : node.prefix,
            filter: !mixin && function(d) {
      ...
      media: function(node) {
        ...
        mediaRules.push({
          ...
          declarations: this.visit(decl).filter(this.filter || Boolean),
          position: node.position
        })
