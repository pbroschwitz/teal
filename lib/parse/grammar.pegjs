...
Assignment
  = left:Variable _ '=' _ right:Exp EOS? {
...
Element
  = tag:HtmlIdentifier cls:ClassName? _ decl:Block {
...
Content
  = c:(Exp / Element / Reference / Directive) {
...
KeyframeValues
  = n: KeyframeValue m:(',' __ KeyframeValue)* { return list(n, m) }
...
Selectors
  = n:Selector m:(',' __ Selector)* { return list(n, m) }
...
ArgumentList
  = n:Exp? m:(',' __ Exp)* { return list(n, m) }
