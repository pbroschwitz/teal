...
HTML.prototype.compile = cache(function(ast) {
  if (typeof ast == 'string') ast = this.teal.parse(ast)

  var code = this.visit(ast)
  this.teal.expose({ file: ast.file + '.js', content: code, className: ast.root.class })
  return code
})
...
HTML.prototype.process = function(mods) {
  ...
  mods.forEach(this.compile, this)
}
